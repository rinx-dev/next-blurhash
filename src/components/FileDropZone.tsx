...
const FileDropZone = () => {
    ...
    return (
        <div
            className={cn("h-full flex items-center justify-center", isDragging && "bg-foreground/10")}
        ...
        >
            <input
                ...
                style={{ display: 'none' }}
            />
            <p>{isDragging ? 'Drop the image here' : 'Drag and drop a image here or click to select'}</p>
        </div>
    );
};
